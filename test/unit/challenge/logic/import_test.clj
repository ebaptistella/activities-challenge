...
(deftest parse-csv-rows-test
  ...
  (testing "returns empty seq for nil or empty string"
    (is (empty? (logic.import/parse-csv-rows nil)))
    (is (empty? (logic.import/parse-csv-rows "")))))
