...
(defn enrich-activity->wire
  "Converts enriched activity model to wire format.
  
  Parameters:
  - enriched-activity: Map with :activity, :activity_type, :unit, :amount, :kind
